 ...
 */
PWMServoDriver::PWMServoDriver(const uint8_t addr)
 ...
 */
uint8_t PWMServoDriver::setPWM(uint8_t num, uint16_t on,
                                        uint16_t off) {
#ifdef ENABLE_DEBUG_OUTPUT
 ...
 */
void PWMServoDriver::writeMicroseconds(uint8_t num,
 ...
 * introspect)
 */
uint32_t PWMServoDriver::getOscillatorFrequency(void) {
